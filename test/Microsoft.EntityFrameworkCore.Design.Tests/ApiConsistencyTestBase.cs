...
namespace Microsoft.EntityFrameworkCore
{
    public abstract class ApiConsistencyTestBase
    {
        ...
        private IEnumerable<string> GetCancellationTokenExceptions() => Enumerable.Empty<string>();

        private IEnumerable<string> GetAsyncSuffixExceptions() => Enumerable.Empty<string>();
