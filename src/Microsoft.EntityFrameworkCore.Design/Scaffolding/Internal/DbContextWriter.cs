            ...
            using (_sb.Indent())
            {
                ...
                foreach (var sequenceConfig in _model.SequenceConfigurations)
                {
                    ...
                    _sb.Append("modelBuilder.HasSequence")
                        .Append(!string.IsNullOrEmpty(sequenceConfig.TypeIdentifier) ? "<" + sequenceConfig.TypeIdentifier + ">" : string.Empty)
                        .Append("(" + sequenceConfig.NameIdentifier)
                        .Append(!string.IsNullOrEmpty(sequenceConfig.SchemaNameIdentifier) ? ", " + sequenceConfig.SchemaNameIdentifier : string.Empty)
                        .Append(")");
